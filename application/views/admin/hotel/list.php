        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <div class="col-md-2">
                  <a href="<?= base_url('dashboard/addHotel')?>"><button type="button" class="btn btn-block bg-gradient-primary">Add Hotel </button></a>
                </div>
              </div>
              <?php  
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <td><?php echo $value->hotel_code?></td>
                    <td><img src="<?= base_url('uploads/'.$value->hotel_image)?>" style="width: 80px;"></td>
