  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hotel Report  List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('dashboard')?>">Home</a></li>
              <li class="breadcrumb-item active">Hotel Report List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-md-3">
            <form method="POST" action="<?= base_url('dashboard/getHotelReport') ?>">
                <div class="form-group">
                    <label for="hotel_filter">Filter by Username:</label>
                    <select class="form-control" id="hotel_filter" name="hotel_filter">
                        <option value="">All</option>
                        <?php foreach ($hotel_info as $user) { ?>
                            <option value="<?= $user->id ?>"><?= $user->hotel_name ?></option>
                        <?php } ?>
                    </select>
                </div>
